...
def banner():
    ...
    print GG+"√==========================================√"
    print WW+"  |            MOD BY: ⊱ALEY༻₁₀₀ᵏ            |"
    print GL+"  |       Tu nai to teri yad sai T       |"
    print WW+"  |            FACEBOOK: --            |"
    print Y+"  |             INSTAGRAM: --              |"
    print GL+"  |---------------------------------------------|"
    print GL+"  | Github: Aleykashanbrand༻₁₀₀ᵏ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
...
print wd+"         https://www.github.com/aleykashanbrand "
reload(sys)
...
if 'access_token' in op:
    ...
    print ("\033[39m[\033[31m+\033[39m] Login Facebook")
else:
    print ("\033[39m[\033[31m+\033[39m] \033[31mLogin Goggle")
    sys.exit()
